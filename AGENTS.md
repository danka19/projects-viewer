...
16. Whenever asking the human a question that requires a choice or decision, include a clearly identified recommended answer, the main reason for it, and the practical tradeoff of the alternatives.
