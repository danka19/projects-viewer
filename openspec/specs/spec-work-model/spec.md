# Specification Work Model Specification

## Purpose

Define truthful implementation progress and evidence semantics for normalized specification work.
...
- **WHEN** an `accepted-capability` has no owned tasks and no explicit implementation-final evidence
