...
- [`improve-dashboard-evidence-trust`](../openspec/changes/improve-dashboard-evidence-trust/) is the planned follow-on that restores scanner and search evidence trust after `harden-mcp-context-api`; [`API_UX_TRUST_AUDIT_2026-07-12.md`](audits/API_UX_TRUST_AUDIT_2026-07-12.md) is the canonical evidence source.
