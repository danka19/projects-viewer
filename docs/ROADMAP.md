...
- Current phase: no active implementation phase. Phase 3 is accepted and closed; Phase 4 is not planned in detail yet. Its first hardening slice is implemented, accepted into main specs, and archived at `openspec/changes/archive/2026-07-12-harden-mcp-context-api/`.
