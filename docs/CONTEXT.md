...
| Project timeline | Proposed horizontal visualization of ordered project phases with one optional expanded child-step timeline. | Canonical proposed behavior is in `openspec/changes/redesign-dashboard-project-timeline/`; it preserves existing theme/status vocabulary and remains read-only. |
